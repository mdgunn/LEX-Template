...
Script.filterent=nil --entity "Entity Filter"
...
function Script:Trigger(entity)
		...
		entity:SetVelocity(self.PushForceDir, true) --Should this be AddForce?
		self.currentPushForceDir = Vec3(0,0,0)	
...
function Script:ShouldTrigger(entity)
	...
	if self.filterent~=nil then
		if entity ~= self.filterent then
			return false
		end
	end
