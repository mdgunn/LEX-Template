...
void main()
{
	...
	ex_color2 = vec4(entitymatrix[0][3],entitymatrix[1][3],entitymatrix[2][3],entitymatrix[3][3]);
	...
	ex_color2 *= vec4(1.0-vertex_color.r,1.0-vertex_color.g,1.0-vertex_color.b,vertex_color.a) * materialcolordiffuse;
}
@OpenGLES2.Vertex
...
void main(void)
{
	...
	outcolor2 *= texture(texture4,ex_texcoords0);
	...
	float glowammount = ex_color.a * 2;
	fragData2 = vec4(outcolor2.rgb*glowammount,specular);
}
